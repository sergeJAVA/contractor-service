...
public class ContractorRepository {
    ...
    /**
     * Получает подрядчика по его уникальному идентификатору (ID) со всей связанной информацией.
    ...
    public Contractor save(Contractor contractor) {
        ...
        // Возвращаем подрядчика, возможно, с обновленными служебными полями, если они были считаны
    ...
    /**
     * Выполняет логическое удаление подрядчика, устанавливая поле `is_active` в `FALSE`.
     *
     * @param id ID подрядчика, который нужно удалить.
    ...
    /**
     * Выполняет поиск подрядчиков с возможностью фильтрации и пагинации.
     *
    ...
    /**
     * Получает общее количество активных подрядчиков, соответствующих заданным фильтрам.
